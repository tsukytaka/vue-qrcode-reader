<template lang="html">
  <div class="label-stream-wrapper">
    <!--
    ...
    <video
      ref="video"
      :class="{ 'label-stream-camera--hidden': !shouldScan }"
      class="label-stream-camera"
      autoplay
      muted
      playsinline
    ></video>
    ...
    <canvas ref="trackingLayer" class="label-stream-overlay"></canvas>

    <div class="label-stream-overlay">
      <slot></slot>
    </div>
  </div>
</template>
